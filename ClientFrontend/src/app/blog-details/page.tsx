            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  Kataragama, a sacred Sri Lankan town, harmonizes Hindu, Buddhist, and indigenous traditions. The Kataragama 
                  Devalaya and Kirivehera Stupa draw pilgrims with vibrant rituals and serene spiritual heritage.  
                  Beyond its spiritual allure, Kataragama is surrounded by breathtaking natural beauty.
                  </p>

                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed text-justify">
                    Kataragama, nestled amidst lush greenery, is a spiritual haven where tradition and nature converge. The sacred Menik Ganga (Gem River) invites pilgrims for cleansing rituals, adding a mystical aura to the town. Nearby, the majestic Yala National Park offers a glimpse into Sri Lanka's diverse wildlife, featuring elephants, leopards, and vibrant bird species. Kataragama seamlessly combines spiritual devotion with natural beauty, making it an exceptional destination for those seeking cultural richness and serene escapes.
                  </p>  
                    ...
                    <a 
                      ...
                      className="text-primary underline dark:text-white mb-5"
                    >
                      Click hear to more details about Katharagama
                    </a>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed text-justify">
                    Kataragama is a sacred destination known for its cultural harmony and spiritual significance. 
                    Nestled amidst lush landscapes, it offers a unique blend of devotion, history, and nature. From 
                    the iconic Kataragama Devalaya to the serene Kirivehera Stupa, every corner of this town tells a story of faith and heritage.
                  </p>
                  <ul className="mb-10 list-inside list-disc text-body-color">
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                    Witness vibrant rituals at the Kataragama Devalaya, dedicated to Lord Kataragama.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                    Visit the sacred Kirivehera Stupa, a symbol of Buddhist heritage.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                    Experience the tranquil Menik Ganga, where pilgrims perform purification rituals.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                    Explore the nearby Yala National Park, home to diverse wildlife and stunning landscapes.
                    </li>
                  </ul>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      Embark on a spiritual journey through Kataragama, where rich traditions, sacred sites,
                      and breathtaking landscapes unite to offer a transformative experience for every traveler
                      and pilgrim.
                    </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed text-justify">
                    Kataragama blends spiritual devotion and natural beauty, attracting pilgrims to its sacred 
                    shrines and tranquil Menik Ganga. Its cultural harmony and nearby wildlife adventures make it a
